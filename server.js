//IT WILL RUN ON OTHER DEVICES WHEN U SEND YOU IP ADDRESS
//VIA CMD LIKE ipconfig THEN the ip address of the wifi write that and then :3000
//BUT IT WILL RUN ONLY WHEN THE DEVICES WILL BE CONNECTED TO THE SAME WIFI
